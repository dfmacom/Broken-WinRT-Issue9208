...
using Broken_WinRT.Code.Utilities.Helpers;
using Broken_WinRT.Core.Services.Files;
using Broken_WinRT.Core.Utilities.Helpers.Serialization.JSON;
...
{
    private const string _defaultApplicationDataFolder = "Broken_WinRT/ApplicationData";
    private const string _defaultLocalSettingsFile = "LocalSettings.json";

    private readonly IFileService _fileService;
    private readonly LocalSettingsOptionsModel _options;
    ...
    public LocalSettingsService(IFileService fileService, IOptions<LocalSettingsOptionsModel> options)
    {
    ...
    public async Task SaveSettingAsync<T>(string key, T value)
    {
        ...
        else
        {
            ...
            await Task.Run(() => _fileService.SaveToJson(_applicationDataFolder, _localsettingsFile, _settings));
        }
    }
}
